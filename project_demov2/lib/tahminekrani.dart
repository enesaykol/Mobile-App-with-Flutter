        ...
        child: Column(
          ...
          children: [
            ...
            Padding(
              ...
              child: Text(
                "Yardım : $rasgeleSayi elma ile $rasgeleSayi1 elma toplanırsa sonuç ne olur ?",
              ...
              child: Padding(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () {
                    ...
                    if (tahmin > sonuc) {
                      setState(() {
                        yonlendirme = "Cevabın yanlış biraz daha az olabilir mi ?";
                      });
                    }

                    if (tahmin < sonuc) {
                      setState(() {
                        yonlendirme = "Cevabın yanlış biraz daha fazla olabilir mi ?";
                      });
                    }
